...
setup(
    ...
    packages = ['SoN','SoN.plots'], #packages (folders containing __init__.py) that will end up in site-packages
    ...
    package_data = {'SoN': ['documentation/*.ipynb']} #include the ipython notebook documentation
